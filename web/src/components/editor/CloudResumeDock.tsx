        ...
        <div className="mt-5 space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3 border border-[rgba(125,139,153,0.16)] bg-black/20 px-4 py-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button type="button" onClick={clearAuth} className="border border-[rgba(255,138,61,0.35)] px-4 py-2 font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--warning-orange)] transition hover:bg-[rgba(255,138,61,0.08)]">
                {t("cloud.logout")}
              </button>
            </div>
          </div>

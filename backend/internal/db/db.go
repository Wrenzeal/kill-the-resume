...
func Connect(cfg config.Config) (*gorm.DB, error) {
	...
	if err := gormDB.AutoMigrate(&models.User{}, &models.Resume{}, &models.JobPosting{}, &models.JobSearchCache{}, &models.JobSearchResult{}, &models.JobRadarPreference{}, &models.JobRadarJobState{}, &models.JobRadarPluginToken{}); err != nil {
